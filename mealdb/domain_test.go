...
// HTTP behaviour is covered in mealdb_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "mealdb://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("mealdb", "about")
	if err != nil || got.String() != "mealdb://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want mealdb://page/about", got.String(), err)
	}
}
