...
Most of these come down to network reality or how mealdb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mealdb rate-limits like any public site. mealdb already paces
...
Where a surface is gated, mealdb reads a cookie or token you supply
...
`mealdb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mealdb actually did
